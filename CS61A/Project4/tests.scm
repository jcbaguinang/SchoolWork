...
; expect (2 3 (car (3 4)))
'(2 3 ('car '(3 4)))
; expect (2 3 ((quote car) (quote (3 4))))
'(square x)
; expect (square x)
;Problem 7:
(begin (+ 4 5) (car '(4 5)))
...
; expect (3 5)
(define a 8)
(begin (square a) (define a 2) (square a))
; expect 4
(begin (begin (square 2)) 'x)
; expect x
;Problem 8:

(define z (lambda (x y) (* x (* y y))))
; expect z
(z 3 4)
; expect 48
(define a (lambda (x y) (print x) (print y) (* x y)))
; expect a
(a 3 4)
; expect 12
;Problem A9
...
; expect f
f
; expect (lambda (x) (* (- x 3) x))
;Problem B11
(define (f x x) (* x x))
; expect Error
(define (f x (z y)) (* z (* x y)))
; expect Error
;Problem 12: Same as the Lambda Tests
;Problem A13
(if (odd? 4) 'hello 5)
; expect 5
(if (symbol? 3) "Yes" (if (odd? 4) 12 (if (even? 6) "this is the one" "not this")))
; expect "this is the one"
(if (number? x) "hi")
; expect "hi"
(if (number? 'x) "hi")
; expect okay
(if (list? (append (list 5 6) (list 1 2 3 4))) (+ 4 5) (* 3 4))
; expect 9
;Problem B14
(and (and) (or))
; expect False
