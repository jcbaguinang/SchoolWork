...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant():
            ...
            if self.ant is None:
                ...
                if self.ant.can_contain(insect) and not insect.container:
                    self.ant.contain_ant(insect)
                    insect.place = self
                    return
                elif not self.ant.can_contain(insect) and insect.container:
                    insect.contain_ant(self.ant)
                    self.ant = insect
                    return
                assert self.ant.can_contain(insect) or insect.container, 'Two ants in {0}'.format(self)
        else:
    ...
    def remove_insect(self, insect):
        ...
        elif type(insect) is QueenAnt and insect.my_number <= 1:
            return
        else:
...
class Insect(object):
    ...
    def __init__(self, armor, place=None):
        ...
        self.armor = armor
        self.place = place  # set by Place.add_ainsect and Place.remove_insect
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        if current_place != hive and count >= self.min_range and count <= self.max_range:
            if len(current_place.bees) > 0:
                return random_or_none(current_place.bees)
        if current_place.entrance != hive:
            count += 1
...
class QueenAnt(ScubaThrower):
    ...
    def __init__(self):
        ...
        self.my_number = QueenAnt.num_queen
        self.empowered_ants = []
    ...
    def action(self, colony):
        ...
        if self.my_number  > 1:
            ...
            self.throw_at(self.nearest_bee(colony.hive))
            current_place = self.place
            while current_place != colony.hive:
                if current_place.ant != None and current_place.ant not in self.empowered_ants and current_place.ant is not self:
                    self.empowered_ants.append(current_place.ant)
...
class SlowThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        if target:
            target.action = apply_effect(make_slow, target, 3)
...
class StunThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        if target:
            target.action = apply_effect(make_stun, target, 1)
