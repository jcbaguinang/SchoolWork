...
public class RunIterator implements Iterator {
  private DListNode2 curr;
  private DListNode2 orig;
  ...
  // the encoding.
  public RunIterator(DList2 pixels) {
    curr = pixels.head;
    orig = pixels.head;
  }
  ...
  public int[] next() {
    ...
    return new int[] {curr.num, curr.red, curr.green, curr.blue};
  }
