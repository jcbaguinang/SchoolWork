...
public class DListNode extends ListNode {
  ...
  protected DListNode partnerEdge;
   ...
   *  @param edges whether the node will contain an edge list.
   */
  DListNode(Object i, DList l, DListNode p, DListNode n, boolean edges) {
    item = i;
    myList = l;
    prev = p;
    next = n;
  ...
  /**
  *  edgeList() returns the list of edges contained by this DListNode.
  **/
  public DList edgeList() {
    return edges;
  }
  /**
  *  partnerEdge(DListNode edge) takes in a DListNode parameter, and sets the partnerEdge to the parameter.
  *  @param the partnerEdge that will be set.
  **/
  public void partnerEdge(DListNode edge) {
    partnerEdge = edge;
  }
  /**
  *  partnerEdge() returns the partnerEdge of this DListNode.
  *  @return returns the partnerEdge of this node.
  **/
  public DListNode partnerEdge() {
    return partnerEdge;
  }
  /**
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    DListNode b = ((DList) myList).newNode(item, (DList) myList, this, this.next, false);
    this.next.prev = b;
    this.next = b;
    myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    DListNode b = ((DList) myList).newNode(item,  (DList) myList, this.prev, this, false);
    this.prev.next = b;
    this.prev = b;
    myList.size++;
  }
